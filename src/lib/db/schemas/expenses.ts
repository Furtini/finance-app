...
export const categories = pgEnum('categories', ['needs', 'leisure', 'travels', 'house', 'education', 'free']);
export const subcategories = pgEnum('subcategories', ['groceries', 'transport', 'restaurant', 'pharmacy', 'events', 'books', 'games', 'furniture', 'other']);
